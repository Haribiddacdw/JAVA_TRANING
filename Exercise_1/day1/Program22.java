...
public class Program22 {
	public static void main(String args[])
	{
		...
		//System.out.print("Private data members Access"+test.number2);  //The field Test.number2 is not visible Because it is private variable
		
		System.out.println("Protected data members Access :"+test.number3);
		System.out.println("Default data members Access :"+test.number4);
		System.out.println();
		test.display1();
		//test.display2();  //The method display2() from the type Test is not visible Because it is private method
		test.display3();
		test.display4();
		test.getNumber2();
	}
